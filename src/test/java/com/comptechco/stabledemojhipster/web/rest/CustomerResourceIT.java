...
import com.comptechco.stabledemojhipster.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).phoneNumber(DEFAULT_PHONE_NUMBER);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
        return customer;
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
